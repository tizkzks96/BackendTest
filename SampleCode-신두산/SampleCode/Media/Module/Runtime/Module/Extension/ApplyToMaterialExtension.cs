...
namespace RenderHeads.Media.AVProVideo
{
    ...
    public sealed class ApplyToMaterialExtension : ApplyToBase
    {
        [Header("Display")]
        [Space(8f)]
        ...
        public Action<bool> onChangedDefaultTexture;
        public Action<Texture> onAppliedMapping;
        ...
        {
            onChangedDefaultTexture?.Invoke(texture == _defaultTexture);
